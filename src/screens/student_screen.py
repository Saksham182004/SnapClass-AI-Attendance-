...
def student_dashboard():
    ...
    for i , sub_node in enumerate(subjects):
        ...
        def unenroll_btn(s=sub, s_id=sid):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name" , placeholder='E.g. Saksham')
            ...
            try:
                audio_data = st.audio_input("Record a short phrase Like I am present ,My name is Saksham")
            except Exception:
                ...
                if new_name:
                    with st.spinner("Creating Profile"):
                        ...
                        if encodings:
                            ...
                            st.error("Coudn't capture your facial features for registration")
